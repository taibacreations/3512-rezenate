...
const FALLBACK_ICONS: Record<number, (color: string) => React.ReactNode> = {
  0: (c) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="xl:w-[32px] xl:h-[32px] w-[24px] h-[24px]">
      <path d="M16 27.5S3.5 20 3.5 11.5A6.5 6.5 0 0 1 16 8.257 6.5 6.5 0 0 1 28.5 11.5C28.5 20 16 27.5 16 27.5Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="none"/>
    </svg>
  ),
  1: (c) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="xl:w-[32px] xl:h-[32px] w-[24px] h-[24px]">
      <path d="M16 4a8 8 0 0 1 5 14.2V21a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-2.8A8 8 0 0 1 16 4Z" stroke={c} strokeWidth="2" fill="none"/>
      <path d="M13 25h6M14 28h4" stroke={c} strokeWidth="2" strokeLinecap="round"/>
    </svg>
  ),
  2: (c) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="xl:w-[32px] xl:h-[32px] w-[24px] h-[24px]">
      <path d="M18 4L8 18h8l-2 10 14-16h-8L18 4Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="none"/>
    </svg>
  ),
  3: (c) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="xl:w-[32px] xl:h-[32px] w-[24px] h-[24px]">
      <path d="M16 5v22M10 27h12" stroke={c} strokeWidth="2" strokeLinecap="round"/>
      <path d="M16 7L6 12l-2 4a6 6 0 0 0 12 0L14 12 16 7Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="none"/>
      <path d="M16 7l10 5 2 4a6 6 0 0 1-12 0l2-4 10-5Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="none"/>
    </svg>
  ),
  4: (c) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="xl:w-[32px] xl:h-[32px] w-[24px] h-[24px]">
      <path d="M2 16h4M6 16c0-4 2-8 4-8s4 8 4 8 2 8 4 8 4-8 4-8M26 16h4" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
};
...
const FALLBACK_ITEMS: ValueItem[] = [
  { id: "01", title: "Meraki",        desc: "We bring heart to everything we do",                           expanded: "From the Greek for 'putting your soul into your work,' Meraki means pouring soul, care, and creativity into what we do, leaving a piece of ourselves in everything we touch. That spirit runs through every detail we craft, every leader we introduce, and every relationship we nurture." },
  { id: "02", title: "Wisdom",        desc: "We make thoughtful decisions.",                                expanded: "Wisdom is not just knowledge — it is knowing when to act, when to listen, and when to step back. We draw on deep experience and careful discernment to guide our clients and partners toward decisions that stand the test of time." },
  { id: "03", title: "Rezolutionary", desc: "We believe everyone has the power to shape what happens next.", expanded: "Being Rezolutionary means refusing to accept the status quo as the ceiling. We challenge assumptions, champion bold thinking, and stand beside leaders who are courageous enough to reimagine what is possible — and then make it real." },
  { id: "04", title: "UPEKKHA",       desc: "We meet every moment with balance.",                           expanded: "Upekkha is a Pali word for equanimity — the ability to remain steady and open-hearted in the face of uncertainty. We bring that calm, balanced presence to every engagement, ensuring clarity never gets lost in the noise." },
  { id: "05", title: "CADENCE",       desc: "We move with rhythm and intention.",                           expanded: "Great leadership is not a sprint — it is a rhythm sustained over time. Cadence is our commitment to consistent, intentional momentum: showing up with the same energy, rigour, and care whether it is day one or year five of a partnership." },
];
...
const Values = ({ data }: ValuesProps) => {
  ...
  const cardPositions = [
    ...
    "left-[4%] xl:top-[68vh] 2xl:top-[71.5vh] top-[58vh]",
  ];
  ...
  return (
    <>
        ...
        <div className="2xl:pt-[8.3vh] xl:pt-[10vh] pt-[5vh] max-w-[1480px] mx-auto xl:px-10 md:px-6 px-4">
          ...
          <div>
            ...
            <div className="md:absolute 2xl:left-[13.8%] xl:left-[8%] lg:left-[6%] md:left-[3%] top-[3%]">
              <img ref={ballRef} src="/value-ball1.webp" alt="value-ball" style={{ opacity: 0 }} className="2xl:w-[938px] 2xl:h-[1081px] xl:w-[850px] md:w-[750px] w-full xl:h-[1000px] md:h-[850px] h-auto will-change-transform" />
            </div>
            ...
            <div className="relative xl:mt-[8.2vh] mt-[5vh] flex flex-col gap-[2vh] md:block pb-[15vh] md:pb-0">
              {items.map((v, i) => (
                <div
                  ...
                  style={{ opacity: 0 }}
                  className={`value-card bg-white border border-[#DEE6E9] xl:rounded-[22px] rounded-[18px] xl:w-[680px] md:w-[550px] w-full 2xl:h-[130px] xl:h-[110px] h-[100px] flex items-center md:absolute cursor-pointer
                ...
                >
                  ...
                  <div className="flex pl-6 pr-15 xl:gap-6 gap-3">
                    <div className="2xl:w-[76px] 2xl:h-[76px] md:w-[60px] w-[45px] md:h-[50px] h-[50px] 2xl:rounded-[29px] md:rounded-[20px] rounded-[15px] flex justify-center items-center shrink-0" style={{ backgroundColor: `${accentColor}1F` }}>
      ...
      {/* ── Overlay ── */}
      {active && (
        <div ref={overlayRef} style={{ opacity: 0 }} onClick={closeOverlay} className="fixed inset-0 z-[999] flex items-center justify-center">
          ...
          <button onClick={closeOverlay} className="absolute top-7 right-9 z-20 w-9 h-9 flex items-center justify-center rounded-full border border-[#DEE6E9] text-black/40 hover:text-[#9564F4] hover:border-[#9564F4] transition-all duration-200 text-[15px] bg-white/80">✕</button>
          <div
            ref={overlayCardRef}
            onClick={(e) => e.stopPropagation()}
            style={{ opacity: 0, background: "linear-gradient(160deg, #ffffff 0%, #f7f4ff 60%, #f0ebff 100%)", border: `1px solid ${accentColor}2E`, boxShadow: `0 8px 48px ${accentColor}1F, 0 2px 0 rgba(255,255,255,0.9) inset` }}
          ...
          >
            ...
            <p ref={overlayTextRef} style={{ opacity: 0 }} className="font-mulish font-normal text-[17px] text-black/65 xl:leading-[185%] leading-[151%] max-w-[560px] mx-auto">{active.expanded}</p>
