...
const LoadingScreen = ({ data }: LoadingScreenProps) => {
  ...
  useEffect(() => {
    ...
    gsap.set(bubbleRef.current, {
      scaleX: 0.92, scaleY: 0.96, x: 0, y: 0, rotation: 0,
    ...
    const bubbleFloat = gsap.timeline({
      repeat: -1, yoyo: true, defaults: { ease: "sine.inOut" },
    });

    bubbleFloat
      .to(bubbleRef.current, { x: 18, y: -14, rotation: 1.5, scaleX: 1.02, scaleY: 0.99, duration: 3.8 }, 0)
      .to(bubbleRef.current, { x: -14, y: 12, rotation: -1.5, scaleX: 0.99, scaleY: 1.02, duration: 4.2 }, 3.8)
      .to(bubbleRef.current, { x: 10, y: 16, rotation: 1.0, scaleX: 1.01, scaleY: 0.99, duration: 3.6 }, 8.0)
      .to(bubbleRef.current, { x: -10, y: -10, rotation: -1.0, scaleX: 0.99, scaleY: 1.01, duration: 4.0 }, 11.6);

    const bubbleImageFloat = gsap.to(bubbleImageRef.current, {
      x: -8, y: 6, rotation: -1.5, duration: 5.5, ease: "sine.inOut", repeat: -1, yoyo: true,
    });
